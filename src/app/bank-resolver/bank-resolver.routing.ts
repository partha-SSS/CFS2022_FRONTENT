...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'LR_Challan', component: LoanChalanPrintComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LR_LoanChallPrn', component: DuplicateChallPrintComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LM_ps_master', component: PsMasterContaiComponent, canActivate: [AuthGuard] },
      { path: 'LM_po_master', component: PoMasterContaiComponent, canActivate: [AuthGuard] },
