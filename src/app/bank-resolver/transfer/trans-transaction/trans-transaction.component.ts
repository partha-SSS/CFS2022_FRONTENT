...
export class TransTransactionComponent implements OnInit {
  ...
  checkDebitBalance(tdDefTransTrnsfr: td_def_trans_trf) {
    ...
    if ((+tdDefTransTrnsfr.amount) > (+tdDefTransTrnsfr.clr_bal) && (tdDefTransTrnsfr.acc_type_cd==1||tdDefTransTrnsfr.acc_type_cd==8||tdDefTransTrnsfr.acc_type_cd==7)) {
      this.HandleMessage(true, MessageType.Error, 'Amount can not be Greater-than Account Balance.');
      tdDefTransTrnsfr.amount = 0;
      return;
    }
