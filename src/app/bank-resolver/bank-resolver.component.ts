...
// import { BandwidthService } from '../_service/bandwidth.service';
@Component({
...
export class BankResolverComponent implements OnInit,OnDestroy {
  ...
  ngOnInit(): void {
    // this.bandwidthService.isLowBandwidth$.subscribe(isLow => {
    ...
    //     else{
    //     this.logoutUser() ;
    //     alert("You're being timed out due to LowBandwidth, Please login again after you will logged out automatically.");
