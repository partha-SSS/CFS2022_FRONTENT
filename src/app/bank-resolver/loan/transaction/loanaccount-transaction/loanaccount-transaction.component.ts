...
export class LoanaccountTransactionComponent implements OnInit {
  ...
  out_curr_principal:number=0;
  out_ovd_principal:number=0;
 
  out_curr_intt:number=0;
  out_ovd_intt:number=0;
  out_penal_intt:number=0;
    ...
    this.svc.addUpdDel<any>('Loan/GetLoanData', acc1).subscribe(
      res => {
        ...
        if (undefined === acc || acc.tmloanall.loan_id == null) {
          ...
          this.out_curr_principal=(+acc.tmloanall.curr_prn)
          this.out_ovd_principal=(+acc.tmloanall.ovd_prn);
          // this.out_adv_principal=(+acc.tmloanall.);
         
          this.out_curr_intt=(+acc.tmloanall.curr_intt);
          this.out_ovd_intt=(+acc.tmloanall.ovd_intt);
          this.out_penal_intt=(+acc.tmloanall.penal_intt);
    ...
    // this.svc.addUpdDel<any>('Loan/CalculateLoanInterest', tmDep).subscribe(
      res => {
        ...
        if (undefined !== res) {
          ...
          this.out_curr_principal=(+ inttRet.curr_prn_recov) - (+this.tdDefTransFrm.controls.curr_prn_recov.value)
          this.out_ovd_principal=(+inttRet.ovd_prn_recov)- (+this.tdDefTransFrm.controls.ovd_prn_recov.value);
          // this.out_adv_principal=(+acc.tmloanall.);
         
          this.out_curr_intt=(+inttRet.curr_intt_recov)- (+this.tdDefTransFrm.controls.curr_intt_recov.value);
          this.out_ovd_intt=(+inttRet.ovd_intt_recov)-  (+this.tdDefTransFrm.controls.ovd_intt_recov.value);
          this.out_penal_intt=(+inttRet.penal_intt_recov)- (+this.tdDefTransFrm.controls.penal_intt_recov.value);
...
this.i_n_dt=0;
this.out_curr_principal=0;
this.out_ovd_principal=0;
 this.out_curr_intt=0;
 this.out_ovd_intt=0;
  this.out_penal_intt=0;
    ...
    if (this.td.recov_type.value == 'A') {
              ...
              this.svc.addUpdDel<LoanOpenDM>('Common/UpdateTransactionDetails', saveTransaction).subscribe(
                res => {
                 ...
                 this.accDtlsFrm.patchValue({
                  ...
                  if(this.sys.ardbCD=='2' || this.sys.ardbCD=='17'|| this.sys.ardbCD=='25'|| this.sys.ardbCD=='26'){
              ...
              this.svc.addUpdDel<LoanOpenDM>('Loan/InsertLoanTransactionData', saveTransaction).subscribe(
                res => {
                  ...
                  if(this.isRecovery){
                    ...
                    this.out_curr_principal=(+this.fd.curr_principal.value-(+this.td.curr_prn_recov.value) - (+this.td.adv_prn_recov.value))
                    this.out_ovd_principal=(+this.fd.ovd_principal.value-(+this.td.ovd_prn_recov.value));
                    this.out_curr_intt=(+this.fd.curr_intt.value-(+this.td.curr_intt_recov.value));
                    this.out_ovd_intt=(+this.fd.ovd_intt.value-(+this.td.ovd_intt_recov.value));
                    this.out_penal_intt=(+this.fd.penal_intt.value-(+this.td.penal_intt_recov.value));
      ...
      if (this.td.trans_cd.value > 0) {
        this.svc.addUpdDel<LoanOpenDM>('Common/UpdateTransactionDetails', saveTransaction).subscribe(
          ...
          this.out_curr_principal=(this.inttRetForUpdate.curr_prn_recov-(+this.td.curr_prn_recov.value) - (+this.td.adv_prn_recov.value))
          this.out_ovd_principal=(+this.inttRetForUpdate.ovd_prn_recov-(+this.td.ovd_prn_recov.value));
          this.out_curr_intt=(+this.inttRetForUpdate.curr_intt_recov-(+this.td.curr_intt_recov.value));
          this.out_ovd_intt=(+this.inttRetForUpdate.ovd_intt_recov-(+this.td.ovd_intt_recov.value));
          this.out_penal_intt=(+this.inttRetForUpdate.penal_intt_recov-(+this.td.penal_intt_recov.value));
          }
          })
          }
          if(this.isDisburs){
        ...
        this.svc.addUpdDel<LoanOpenDM>('Loan/InsertLoanTransactionData', saveTransaction).subscribe(
          res => {
            ...
            if(this.isRecovery){
              ...
              this.out_curr_principal=(+this.fd.curr_principal.value-(+this.td.curr_prn_recov.value) - (+this.td.adv_prn_recov.value))
              this.out_ovd_principal=(this.fd.ovd_principal.value-(+this.td.ovd_prn_recov.value))
              // this.out_adv_principal=(+this.fd.adv_principal.value)-(+this.td.adv_prn_recov.value);
